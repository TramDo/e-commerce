...
public class SIS {
	...
	public Map<String, StudentBean> retrieveAllStudent() throws Exception {

				
		Map<String, StudentBean> rv = new HashMap<String, StudentBean>();
		rv = stuDao.retrieveAll();
	...
	public Map<String, StudentBean> addStudent(String sid, String givenName, String surName) throws Exception {

		
		Map<String, StudentBean> rv = new HashMap<String, StudentBean>();
		rv = stuDao.add(sid, givenName, surName);
